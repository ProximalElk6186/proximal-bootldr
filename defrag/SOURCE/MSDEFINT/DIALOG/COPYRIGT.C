...
#define BUTTON_Y      DIALOG_Y + 10

#define AMOFCONTROLS 9
...
static struct Window CopyRight = {DIALOG_X, DIALOG_Y,
...
static void Initialise(void)
{
 ...
 Controls[2] = CreateLabel("Copyright 2000, Imre Leber",
                           DIALOGFORCOLOR, DIALOGBACKCOLOR, 
                           TEXT_X, DIALOG_Y+3);
 ...
 Controls[6] = CreateLabel("e-group:  " EGROUP,
                           DIALOGFORCOLOR, DIALOGBACKCOLOR, 
                           TEXT_X, DIALOG_Y+8);
 
 Controls[7] =  CreateHLine(DIALOG_X+1, DIALOG_Y+9, DIALOG_X_LEN-1, 
                            DIALOGFORCOLOR, DIALOGBACKCOLOR);
 
 Controls[8] = CreateCommandButton(&OkButton, BUTTONFORCOLOR, BUTTONBACKCOLOR,
...
void ShowCopyRight()
{
     ...
     OpenWindow(&CopyRight);
     ControlWindow(&CopyRight);
     CloseWindow();
